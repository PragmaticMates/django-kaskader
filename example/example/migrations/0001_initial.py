# Generated by Django 4.2.3 on 2023-12-09 20:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='created')),
                ('modified', models.DateTimeField(auto_now=True, verbose_name='modified')),
                ('model', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='example.brandmodel', verbose_name='car brand model')),
            ],
            options={
                'verbose_name': 'car',
        ...
        migrations.AddField(
            ...
            name='brand',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='example.carbrand', verbose_name='car brand'),
        ),
