...
class BrandModel(models.Model):
    brand = models.ForeignKey(CarBrand, verbose_name=_(u'car brand'), on_delete=models.SET_NULL, null=True)
...
class Car(models.Model):
    ...
    model = models.ForeignKey(BrandModel, verbose_name=_(u'car brand model'), on_delete=models.SET_NULL, null=True)
